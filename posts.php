<?php
    ...
    {
        $query="SELECT * FROM `feeds` WHERE `user`='".$_SESSION['login-id']."' ORDER BY `additionDate` DESC";
        $res=mysqli_query($GLOBALS['conn'], $query);
        $carousel=1;
        if($res!=false)
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content" >
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="ui green button" id="update-post-btn">Update Post</button>
        </div>
    ...
    <div class="col-lg-6 offset-lg-3" style="margin-top: 20px; margin-bottom:20px;  ">
        ...
        <div class="card " >
            ...
            <div class="card-body" align="center" style="margin-top : 10px; ">
                ...
                style="width: 150px;background-color: #ffffff;margin: 25px;margin-left: 25px;margin-top: 0px;padding: 20px;">
                <div class="col-lg-5 offset-lg-0 text-center">
                 <h5 class="border rounded-0 border-dark" style="padding: 10px;color: #000000;">My Posts</h5>
                 <a class="btn btn-outline-primary btn-sm" role="button" style="margin: 0px;padding: 10px;padding-top: 10px;
                 padding-bottom: 10px;padding-right: 10px;padding-left: 10px;margin-right: 5px;" href="home.php">
                 <i class="fa fa-feed"></i>&nbsp; Feed</a>
                    <a class="btn btn-outline-primary btn-sm" role="button" style="margin: 0px;padding: 10px;padding-top: 10px;padding-bottom: 10px;
                    padding-right: 10px;padding-left: 10px;margin-right: 5px;" href="profile.php"><i class="fa fa-user"></i>&nbsp; Profile</a>
                    <a class="btn btn-outline-primary btn-sm" role="button" style="padding: 10px;padding-top: 10px;padding-right: 8px;padding-bottom: 10px;padding-left: 8px;margin-left: 0px; " href="logout.php"><i class="fa fa-sign-out"></i>&nbsp;Log out</a>
             </div>
    ...
    <script type="text/javascript">
        $(document).on('click', '.edit-post-btn', function(){
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    ...
                    {
                        alert("Post doesn't contains text.");
                    }                    
                    ...
                    {
                        alert("Post doesn't exists/you don't have right to edit this post.");
                    }
                }
            });
        });
        ...
        $(document).on('click', '#update-post-btn', function(){
            ...
            $.ajax({
                type: 'POST',
                url: 'update_post.php',
                data: {sno: sno, text: text, search: 'update-post'},
                success: function(response)
                {
                    if(response==true)
                    {
                    ...
                    {
                        alert("Post doesn't exits/you don't have right to edit this post.");
                    }
                }
            });
        });
        ...
        $(document).on('click', '.delete-post-btn', function(){
            ...
            $.ajax({
                type: 'POST',
                url: 'update_post.php',
                data: {sno: sno, search: 'delete-post'},
                success: function(response)
                {
                    if(response==true)
                    {
