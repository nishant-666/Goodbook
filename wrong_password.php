...
<body style="background-size: cover;background-repeat: no-repeat;filter: blur(0px);">
    <div class="col text-right"><a class="btn btn-dark border rounded-0 border-dark" role="button" href="home.php" style="margin: 10px;"><i class="far fa-user"></i>&nbsp; Home</a></div>
    ...
    <div class="row">
        <div class="mx-auto col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php
              if(!isset($_SESSION['profile-changed']))
              echo ' <div class="alert alert-danger  style="position: fixed; z-index: 10; top: 3px;>Error code 666! Please check your Password</div>';
?>
                            <form class="form" role="form" action="update_profile.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="image-area mt-4"><img id="imageResult" src="profile_pic/<?php echo $row['profile']; ?>" alt="No profile pic set" class="img-fluid rounded shadow-sm mx-auto d-block">
                                </div>
                                ...
                                <div class="form-group row" align="center">
                                    ...
                                    <div class="col-lg-12">
                                        <!-- <input type="reset" class="btn btn-outline-dark btn btn-md border rounded-0" value="Reset"> -->
