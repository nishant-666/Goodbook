    ...
    <div class="container text-center" style="background-color: #ffffff;padding: 30px;padding-bottom: 0pz;">
        <div class="row text-center">
            <div class="col-md-4 col-lg-12 col-xl-3 offset-lg-0 offset-xl-5 text-center" style="margin-top: -40px;">
                <h3 class="text-center border rounded-0" style="padding: 20px;font-family: ABeeZee, sans-serif;margin-top: 50px;">Your Profile</h3>
                <img class="img-thumbnail" src="profile_pic/<?php echo $row['profile']; ?>" style="width: 288px;margin-top: 20px;"></div>
            <div class="col-md-4 col-lg-12 col-xl-3 offset-lg-0 offset-xl-5 text-center">
            <a class="btn btn-dark" role="button" href="profileedit.php" style="margin: 50px;">
            <i class="fas fa-pen-fancy"></i>&nbsp; Edit Profile</a>
            </div>
        </div>
