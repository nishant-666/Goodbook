                    ...
                    <div class="card" style="margin-top: 10px;">
                        <div class="card-body text-center" style="background-color: #f9f9f9;padding: 15px;">
                             <?php
                                ...
                                echo ' <div class="alert alert-success style="position: fixed; z-index: 10; top: 3px;>Your Post has been updated! &nbsp;&nbsp;
                            ...
                            <button class="btn btn-outline-primary btn-sm" type="submit" style="padding: 5px;padding-top: 5px;"><i class="far fa-paper-plane"></i>&nbsp; Post Status</button>
                        </form>
                        </div>
                        </div>

                        <div class="col text-center" style="margin-bottom: 10px;margin-top: 10px;">
                            <a class="btn btn-outline-primary btn-sm" role="button" style="padding: 5px;padding-top: 5px;" href="upload.php">
                            <i class="fa fa-file-photo-o"></i>&nbsp; Upload Picture</a></div>

                        <div class="col text-center" style="margin-bottom: 10px;margin-top: 10px;">
                            <a class="btn btn-outline-primary btn-sm" role="button" style="padding: 5px;padding-top: 5px;" href="posts.php">
                            <i class="fa fa-heart"></i>&nbsp; My Posts</a>
